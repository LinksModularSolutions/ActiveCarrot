...
console.log(pageURL);
var pageStatus = pageURL.includes("https://secure.activecarrot.com/login?site=");
console.log(pageURL.includes("https://secure.activecarrot.com/login?site="));
...
console.log(pageURL);
var pageStatus = pageURL.includes("https://secure.activecarrot.com/public/session/step2/");
console.log(pageURL.includes("https://secure.activecarrot.com/public/session/step2/"));
...
console.log(pageURL);
var pageStatus = pageURL.includes("https://secure.activecarrot.com/customer/mobile/login?site=");
console.log(pageURL.includes("https://secure.activecarrot.com/customer/mobile/login?site="));
...
$("a.book").on('click', function(){
     window.location = "https://secure.activecarrot.com/?site=584";    
});
}
